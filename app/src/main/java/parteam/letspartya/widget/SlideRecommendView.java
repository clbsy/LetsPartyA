package parteam.letspartya.widget;
...
import parteam.letspartya.Utils;
import parteam.letspartya.model.bean.PartyRecommendBean;
import parteam.letspartya.util.Constants;
            ...
            switch (msg.what){
                case MSG_UPDATE_UI:
                    for(int i = 0;i <mDataList.size();i++){
                        ...
                        Utils.displayImage(mImageViewList.get(i),recommendBean.getUrl(),mImageOptions);
                    }
